...
class DeepCrackDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.img_paths = make_dataset(os.path.join(opt.dataroot, '{}Cracks'.format(opt.phase)))
        self.lab_dir = os.path.join(opt.dataroot, '{}CracksGroundtruth'.format(opt.phase))
