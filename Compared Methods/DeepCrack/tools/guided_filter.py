...
parser.add_argument('--results_dir', type=str, default='./results/deepcrack')
...
parser.add_argument('--suffix_fused', type=str, default='_fused', help='Suffix of predicted file name')
parser.add_argument('--suffix_sideout', type=str, default='_side1', help='Suffix of side output file name')
parser.add_argument('--suffix_output', type=str, default='_gf', help='Suffix of refined results')
args = parser.parse_args()


if __name__ == '__main__':
    results_dir  = os.path.join(args.results_dir, 'Testing_latest', 'images')
    ...
    for ff, ss in zip(fused_list, sideout_list):
        ...
        suffix_fused = "_fused"
        cv2.imwrite(ff.replace(suffix_fused, args.suffix_output), img_out, 
